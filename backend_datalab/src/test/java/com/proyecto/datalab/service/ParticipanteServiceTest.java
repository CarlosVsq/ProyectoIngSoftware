...
class ParticipanteServiceTest {
    ...
    void testCrearParticipante_RegistraAuditoria() {
        ...
        doNothing().when(auditoriaService).registrarAccion(any(Usuario.class), any(Participante.class), anyString(), anyString(), anyString());
    ...
    void testGuardarRespuestas_Exitoso() {
        ...
        verify(auditoriaService, times(2)).registrarAccion(eq(reclutador), eq(participante), eq("ACTUALIZAR"), eq("Respuesta"), anyString());
    }
    ...
    void testGuardarRespuestas_ParticipanteNoEncontrado() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> participanteService.guardarRespuestas(999, respuestasMap, 1));
    ...
    void testGuardarRespuestas_EditorNoEncontrado() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> participanteService.guardarRespuestas(1, respuestasMap, 999));
    ...
    void testGuardarRespuestas_VariableNoEncontrada() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> participanteService.guardarRespuestas(1, respuestasMap, 1));
